 ...
 */
class Cities_carousal_PayTM: NSObject, HUBComponentWithChildren, HUBComponentWithRestorableUIState, HUBComponentViewObserver, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    var view: UIView?
    var childDelegate: HUBComponentChildDelegate?
    
    private lazy var collectionView = UICollectionView(frame: .zero, collectionViewLayout: Cities_carousal_PayTM.makeCollectionViewLayout())
    private var model: HUBComponentModel?
    private var itemSize: CGSize?
    private var cellReuseIdentifier: String { return "carouselCell" }
    ...
    func loadView() {
        ...
        /*
         IF WISH TO USE VIA A XIB FILE
            // collectionView.register(UINib(nibName: "carouselCell", bundle: nil), forCellWithReuseIdentifier: cellReuseIdentifier)
         */
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
        let horizontalMargin = HUBComponentLayoutManager1.margin
